 ...
 * 
 * 5 accessor methods allows the field values to be reach from other objects.
 * Last one convert all details together to string.
 */
public class WineCase
{
    ...
    /**
     * Return A string representation of this wineCase details
     */
    
    public String toString()
    {
        String details = refNo + ": " + description + ", " + noOfBottles + ", " + price;
        return details;
    }
}
